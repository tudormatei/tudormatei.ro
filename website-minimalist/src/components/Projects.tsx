  ...
  return (
    <section className="max-w-4xl mx-auto px-4 py-10">
      ...
      <div className="relative w-full max-h-[900px]">
        {/* Scrollable Content */}
        <div
          className={`w-full overflow-y-auto scrollbar-thin overflow-x-hidden max-h-[900px] pr-2`}
        ...
        {/* Transparent overlay to block scroll until clicked */}
        {!scrollActivated && (
          <div
            className="absolute inset-0 z-10 bg-transparent"
            onClick={() => setScrollActivated(true)}
